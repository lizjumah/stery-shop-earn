...
export const FloatingHelpButton = () => {
  ...
  return (
    <div className="fixed bottom-24 left-4 z-50 flex flex-col items-start gap-2">
      ...
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-2 bg-primary text-primary-foreground rounded-full px-4 py-2.5 shadow-lg text-sm font-semibold active:scale-95 transition-transform"
