...
export const products: Product[] = [
  {
    ...
    category: "Bakery",
    description: "Fresh baked bread from Stery Bakery. Soft, fluffy and delicious.",
    commission: 10,
    loyaltyPoints: 4,
    inStock: true,
  },
  ...
  },
  {
    ...
    category: "Household",
    description: "Multipurpose cleaning bar soap. Great for laundry and household use.",
    commission: 15,
    loyaltyPoints: 8,
    inStock: true,
  },
  {
    ...
    description: "Fast charging USB cable. Compatible with most Android phones.",
    commission: 100,
    loyaltyPoints: 30,
    inStock: true,
    isOffer: true,
  },
  {
    ...
    category: "Electronics",
    description: "Comfortable in-ear earphones with clear sound quality and bass.",
    commission: 60,
    loyaltyPoints: 20,
    inStock: true,
  },
  {
    ...
    category: "Baby Items",
    description: "Soft, warm baby blanket. Perfect for newborns and infants.",
    commission: 120,
    loyaltyPoints: 50,
    inStock: true,
    isOffer: true,
  },
  {
    ...
    category: "Jewelry",
    description: "Beautiful handmade bracelet. Perfect gift for someone special.",
    commission: 200,
    loyaltyPoints: 60,
    inStock: true,
  },
  {
    ...
    category: "Household",
    description: "Non-stick cooking pan. Durable and easy to clean.",
    commission: 80,
    loyaltyPoints: 35,
    inStock: true,
  },
